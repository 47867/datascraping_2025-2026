...
Audio files are transcribed to text using `faster-whisper` by Klein et al. (see their Github [here](https://github.com/SYSTRAN/faster-whisper)). </br> 
`faster-whisper` is a reimplementation of the original `whisper` by OpenAI (see [here](https://github.com/openai/whisper)). </br>
